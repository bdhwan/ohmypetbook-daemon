...
import os from "os";
import { CONFIG_FILE, CONFIG_DIR, OPENCLAW_HOME, WORKSPACE_DIR, ENCRYPT_SECRET_URL, DECRYPT_SECRETS_URL, HAS_OPENCLAW, DAEMON_VERSION, hasOpenclaw, refreshOpenclawDetection } from "./config.js";
